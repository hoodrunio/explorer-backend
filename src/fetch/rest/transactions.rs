...
impl Chain {
    ...
    pub async fn get_tx_by_hash(&self, hash: &str) -> Result<TxResp, String> {
    ...
    pub async fn get_txs_by_sender(&self, sender_address: &str, pagination_config: PaginationConfig) -> Result<TxsResp, String> {
        let mut query = vec![];
